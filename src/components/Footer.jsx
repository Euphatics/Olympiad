    ...
    <footer className="w-full bg-[#2a2a2a] text-[#b5b5b5] text-[13px] font-sans border-t border-[#333]">
      <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-7 py-5 lg:py-9">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 justify-between">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-8">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <a href="/privacy-policy" className="hover:text-white transition-colors font-bold text-white">Privacy Policy</a>
                </div>
              </div>
          ...
          <div className="w-full lg:w-[40%] flex justify-start lg:justify-end lg:-ml-[120px]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2.5">
                {/* Facebook */}
                <a href="#" className="w-7 h-7 rounded-full bg-[#1877F2] text-white flex items-center justify-center hover:opacity-90 shadow-sm">
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1V12h3v3h-3v6.8c4.56-.93 8-4.96 8-9.8z"/>
                  </svg>
                </a>
                {/* Instagram */}
                <a href="#" className="w-7 h-7 rounded-full bg-gradient-to-tr from-[#F58529] via-[#DD2A7B] to-[#8134AF] text-white flex items-center justify-center hover:opacity-90 shadow-sm">
                ...
                {/* LinkedIn */}
                <a href="#" className="w-7 h-7 rounded-full bg-[#0A66C2] text-white flex items-center justify-center hover:opacity-90 shadow-sm">
                  <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
